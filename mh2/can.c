// Serial over CAN emulation for MH2 boards.
//
...
#include "sched.h" // DECL_INIT
 ...
 #define CAN_FUNCTION  GPIO_FUNCTION(9)  // Alternative function mapping number
...
#if CONFIG_MACH_MH24
 #if (CONFIG_MH2_CANBUS_PA11_PA12 || CONFIG_MH2_CANBUS_PB8_PB9 \
     || CONFIG_MH2_CANBUS_PD0_PD1 || CONFIG_MH2_CANBUS_PI9_PH13)
  #define SOC_CAN CAN1
  #define FILTER_CAN CAN1
  #define CAN_RX0_IRQn  CAN1_RX0_IRQn
  #define CAN_RX1_IRQn  CAN1_RX1_IRQn
  #define CAN_TX_IRQn   CAN1_TX_IRQn
  #define CAN_SCE_IRQn  CAN1_SCE_IRQn
 #elif CONFIG_MH2_CANBUS_PB5_PB6 || CONFIG_MH2_CANBUS_PB12_PB13
  #define SOC_CAN CAN2
  #define FILTER_CAN CAN1
...
CAN_IRQHandler(void)
{
    ...
    if (ier & CAN_IER_TMEIE
        // && SOC_CAN->TSR & (CAN_TSR_RQCP0|CAN_TSR_RQCP1|CAN_TSR_RQCP2)) { //st
        && SOC_CAN->TSR & CAN_TSR_RQCP2) { //mh2
        // Tx
