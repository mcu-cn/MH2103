...
static const struct gpio_pwm_info pwm_regs[] = {
  ...
  #endif
  #if CONFIG_MACH_MH2446
    {TIM2,  GPIO('B',  2),  4, GPIO_FUNCTION(1)},
  #endif
  #if CONFIG_MACH_MH24x5 || CONFIG_MACH_MH2446
  ...
  #endif
    // Pins that map to all klipper defined MH24 procs
    ...
    // {TIM5,  GPIO('A',  2),  3, GPIO_FUNCTION(2)}, MH2103 TIM2~5的channel3不支持PWM比较输出
...
#if CONFIG_MACH_MH2H7 || CONFIG_MACH_MH2G0
