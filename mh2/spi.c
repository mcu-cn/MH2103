...
DECL_CONSTANT_STR("BUS_PINS_spi1a", "PB4,PB5,PB3");
 ...
 #if CONFIG_MACH_MH24 || CONFIG_MACH_MH2G4
...
#if CONFIG_MACH_MH20 || CONFIG_MACH_MH2G0
...
spi_setup(uint32_t bus, uint8_t mode, uint32_t rate)
{
    ...
    if (!is_enabled_pclock((uint32_t)spi)) {
        ...
        // Configure CR2 on MH2 f0/f7/g0/l4/g4
#if CONFIG_MACH_MH20 || CONFIG_MACH_MH27 || \
    CONFIG_MACH_MH2G0 || CONFIG_MACH_MH2G4 || \
    CONFIG_MACH_MH2L4
